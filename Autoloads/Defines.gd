...
const MOVE_SPEED = 3 # multiplier for movespeed when the turn starts
const ATTACK_MULT = 100 # multiplier for all attacks
const CLASH_ENGAGE_RANGE = 100 # if whithin this distance, fighters engage in a clash
const LEFT_BOUNDARY = 0 #
const WIN_TRESHOLD_BLUE = 1440 # percentage of the map to control to win
const RIGHT_BOUNDARY = 1920
const WIN_TRESHOLD_RED = 480
...
var enemies: Registry = preload("res://Data/Registries/Enemies.tres")
var enemies_by_level: Array[Registry] = [
	preload("res://Data/Registries/Enemies0.tres"),
	preload("res://Data/Registries/Enemies1.tres"),
	preload("res://Data/Registries/Enemies2.tres"),
	preload("res://Data/Registries/Enemies3.tres")]
