# GenerationContext.gd
# Shared mutable object passed through the item generation pipeline.
# Decouples generation stages and supports compositional and emergent interactions.
...
var quality: Defines.EQUIP_QUALITY = Defines.EQUIP_QUALITY.Common
